  ...
  return (
    <Card className="col-span-full">
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        <Button onClick={handleScanNow} className="bg-gradient-to-r from-blue-gradient-start to-blue-gradient-end text-white">
      ...
      <CardContent>
        <Tabs defaultValue="metrics" className="space-y-4">
          ...
          <TabsContent value="metrics" className="space-y-4">
            ...
            <div className="text-sm text-muted-foreground border-l-4 border-blue-500 pl-4 py-2 bg-blue-50 rounded-r-md">
